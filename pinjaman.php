...
<body class="bg-gray-100">
    <div class="flex h-screen">
        <div class="w-64 bg-white flex-shrink-0">
            ...
            <nav class="mt-4">
                <a href="dashboard.php" class="flex items-center px-4 py-3 hover:bg-blue-100 text-gray-800">
                ...
                <a href="pengembalian.php" class="flex items-center px-4 py-3 hover:bg-blue-100 text-gray-800">
                    <i class="fas fa-history w-6"></i>
                    <span class="ml-2">Pengembalian</span>
                </a>
                <a href="data-buku.php" class="flex items-center px-4 py-3 hover:bg-blue-100 text-gray-800">
                    <i class="fas fa-book w-6"></i>
                    <span class="ml-2">Data Buku</span>
                </a>
                <a href="profil.php" class="flex items-center px-4 py-3 hover:bg-blue-100 text-gray-800">
